...
public class NotPassPage extends StatusListView {
    private static final String TAG = NotPassPage.class.getSimpleName();

    public NotPassPage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
